...
with open('/home/test/program/self-driving/testing/cache/Dave_dropout/test_outputs/nbc_coverage.pkl', 'rb') as f:
    nbc_cov_dict = pickle.load(f)
# with open('/home/test/program/self-driving/testing/cache/Dave_dropout/test_outputs/nbc_coverage_cache_night_random.pkl', 'rb') as f:
#     nbc_cov_dict = pickle.load(f)
...
def testing():
    ...
    while True:
        ...
        with open('/home/test/program/self-driving/testing/cache/Dave_dropout/test_outputs/nbc_coverage_cache_snow_night_random.pkl', 'wb') \
                as f:
