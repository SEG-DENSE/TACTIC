...
# checkpoint_path = '/home/test/program/self-driving/munit/checkpoints/gen_01000000.pt'
# for night domain
...
# init coverage dict
with open('/home/test/program/self-driving/testing/cache/Chauffeur/train_outputs/layer_bounds.pkl', 'rb') as f:
...
with open('/home/test/program/self-driving/testing/cache/Chauffeur/test_outputs/nbc_coverage.pkl', 'rb') as f:
...
# transform = transforms.Compose([transforms.Resize((new_size, new_size)), transforms.ToTensor(),
...
def testing():
    ...
    while True:
        ...
        # nb_uncovered_sections = calculate_uncovered_sections()
        ...
        with open('/home/test/program/self-driving/testing/cache/Chauffeur/test_outputs/nbc_coverage_cache_snow_night_random.pkl', 'wb') \
                as f:
